...
namespace SpeedRacer.Controllers
{
    public class VehiculoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdVehiculo,Marca,modelo,color,NumSerial,precio_venta,stock,descripcion")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdVehiculo,Marca,modelo,color,NumSerial,precio_venta,stock,descripcion")] Vehiculo vehiculo)
        {
            if (ModelState.IsValid)
            {
